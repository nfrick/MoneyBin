...
namespace DataLayer
{
    ...
    public partial class MoneyBinEntities : DbContext
    {
        ...
        public virtual int sp_BalanceItemInsert(Nullable<int> contaID, Nullable<System.DateTime> data, string historico, string documento, Nullable<decimal> valor, Nullable<bool> afetaSaldo, string grupo, string categoria, string subCategoria, string descricao, string tipo)
        {
